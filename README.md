...
- [ 2023-08-01 (p.26 ~ 40) / 디자인패턴 소개 , 전략 패턴 ](src/main/헤드퍼스트/2일차/2일차.md)
- [ 2023-08-02 (p.41 ~ 55) / 인터페이스 설계 , 캡술화 ](src/main/헤드퍼스트/3일차/3일차.md)
- [ 2023-08-03 (p.56~ 69) / 전략패턴 , 상속보다는 구성](src/main/헤드퍼스트/4일차/4일차.md)
- [ 2023-08-04 (p.70~86) / 옵저버패턴 이해하기 ](src/main/헤드퍼스트/5일차/5일차.md)
- [ 2023-08-05 (p.87~101) / 옵저버패턴 구현  ](src/main/헤드퍼스트/6일차/6일차.md)
- [ 2023-08-07 (p.102~113) / 옵저버패턴 예시 , 푸시 & 풀 방식 ](src/main/헤드퍼스트/7일차/7일차.md)
- [ 2023-08-08 (p.114~125) / 데코레이퍼 패턴 소개 , OCP ](src/main/헤드퍼스트/8일차/8일차.md)
- [ 2023-08-09 (p.126~139) / 데코레이퍼 패턴 코드 예시  ](src/main/헤드퍼스트/9일차/9일차.md)
- [ 2023-08-10 (p.140~152) / 팩토리 패턴 소개  ](src/main/헤드퍼스트/10일차/10일차.md)
- [ 2023-08-11 (p.153~165) / 팩토리 패턴 예시 (피자 가게)  ](src/main/헤드퍼스트/11일차/11일차.md)
- [ 2023-08-12 (p.166~179) / 팩토리 패턴 객체 의존성 , 의존 관계 역전 원칙 DIP  ](src/main/헤드퍼스트/12일차/12일차.md)
- [ 2023-08-14 (p.180~189) / 추상 팩토리 도입  ](src/main/헤드퍼스트/13일차/13일차.md)
- [ 2023-08-15 (p.190~204) / 팩토리 메서드 패턴과 추상 팩토리 패턴  ](src/main/헤드퍼스트/14일차/14일차.md)
- [ 2023-08-16 (p.205~216) / 싱글톤 패턴 소개 (getInstance ,이른 초기화 , DCL)  ](src/main/헤드퍼스트/15일차/15일차.md)
- [ 2023-08-17 (p.217~226) / 싱글톤 패턴 정리  ](src/main/헤드퍼스트/16일차/16일차.md)
- [ 2023-08-18 (p.227~239) / 커맨드 패턴 소개   ](src/main/헤드퍼스트/17일차/17일차.md)
- [ 2023-08-19 (p.240~256) / 커맨드 패턴 구현   ](src/main/헤드퍼스트/18일차/18일차.md)
- [ 2023-08-21 (p.257~271) / 커맨드 패턴 활용   ](src/main/헤드퍼스트/19일차/19일차.md)
- [ 2023-08-22 (p.272~283) / 어댑터 패턴 소개  ](src/main/헤드퍼스트/20일차/20일차.md)
- [ 2023-08-23 (p.284~293) / 실전 어댑터 패턴,Enumeration vs Iterator , fail-fast , 퍼사드 패턴 맛보기  ](src/main/헤드퍼스트/21일차/21일차.md)
- [ 2023-08-24 (p.294~304) / 퍼사드 패턴 소개 , 최소 지식 원칙  ](src/main/헤드퍼스트/22일차/22일차.md)
- [ 2023-08-25 (p.305~316) / 퍼사드 패턴 vs 어댑터 패턴 , 템플릿 메소드 패턴 - 알고리즘 캡슐화 하기  ](src/main/헤드퍼스트/23일차/23일차.md)
- [ 2023-08-26 (p.317~334) / 템플릿 메소드 예시 ,구현  ](src/main/헤드퍼스트/24일차/24일.md)
- [ 2023-09-04 (p.335~345) / 템플릿 메소드 코드   ](src/main/헤드퍼스트/25일차/25일.md)
- [ 2023-09-05 (p.346~360) / 반복패턴 캡슐화하기  ](src/main/헤드퍼스트/26일차/26일차.md)
- [ 2023-09-06 (p.361~373) / Iterator 인터페이스 , 반복자 패턴   ](src/main/헤드퍼스트/27일차/27일차.md)
- [ 2023-09-07 (p.374~386) / 단일 역할 원칙, 반복자 패턴 코드   ](src/main/헤드퍼스트/28일차/28일차.md)
- [ 2023-09-08 (p.387~398) / 컴포지트 패턴 정의   ](src/main/헤드퍼스트/29일차/29일차.md)
- [ 2023-09-09 (p.399~414) / 컴포지트 패턴 구현   ](src/main/헤드퍼스트/30일차/30일차.md)
- [ 2023-09-11 (p.415~427) / 객체의 상태 바꾸기   ](src/main/헤드퍼스트/31일차/31일차.md)
- [ 2023-09-12 (p.428~439) / State 인터페이스 , OCP   ](src/main/헤드퍼스트/32일차/32일차.md)
- [ 2023-09-13 (p.440~452) / 상태 패턴   ](src/main/헤드퍼스트/33일차/33일차.md)
- [ 2023-09-14 (p.453~463) / 프록시 패턴   ](src/main/헤드퍼스트/34일차/34일차.md)
- [ 2023-09-15 (p.464~474) / 원격 메소드 - RMI  ](src/main/헤드퍼스트/35일차/35일차.md)
- [ 2023-09-16 (p.475~488) / 원격 프록시  ](src/main/헤드퍼스트/36일차/36일차.md)
- [ 2023-09-18 (p.489~502) / 프록시 패턴  ](src/main/헤드퍼스트/37일차/37일차.md)
- [ 2023-09-19 (p.503~513) / 보호 프록시  ](src/main/헤드퍼스트/38일차/38일차.md)
- [ 2023-09-20 (p.514~527) / 다양한 프록시 패턴   ](src/main/헤드퍼스트/39일차/39일차.md)
- [ 2023-09-21 (p.528~539) / 복합 패턴(어댑터 , 데코레이터 ,팩토리)   ](src/main/헤드퍼스트/40일차/40일차.md)
- [ 2023-09-22 (p.540~553) / 복합 패턴(컴포지트 , 옵저버)   ](src/main/헤드퍼스트/41일차/41일차.md)
- [ 2023-09-23 (p.554~564) / 복합 패턴 -MVC 패턴 )   ](src/main/헤드퍼스트/42일차/42일차.md)
- [ 2023-09-25 (p.565~579) / 모델, 뷰 , 컨트롤러 코드)   ](src/main/헤드퍼스트/43일차/43일차.md)
- [ 2023-09-26 (p.580~598) / BPM ,심박수 제어 코드)   ](src/main/헤드퍼스트/44일차/44일차.md)
- [ 2023-09-27 (p.599~609) / 디자인 패턴 정의 ,범주)   ](src/main/헤드퍼스트/45일차/45일차.md)
- [ 2023-09-28 (p.610~621) / 디자인 패턴 사용 지침)   ](src/main/헤드퍼스트/46일차/46일차.md)
- [ 2023-09-29 (p.622~635) / 다양한 디자인 패턴 (브리지 패턴 , 빌더 패턴)   ](src/main/헤드퍼스트/47일차/47일차.md)
- [ 2023-09-30 (p.636~649) / 다양한 디자인 패턴 (책임 연쇄, 플라이웨이트 ,인터프리터 ,중재자 , 메멘토 , 비지터 패턴)   ](src/main/헤드퍼스트/48일차/48일차.md)
...
- [75일차 : 2024-07-05 (p. 410 ~ 411  ) / 아이템 77. 예외를 무시하지 말라      ](effective-java/docs/75일차/75일차.md)
- [76일차 : 2024-07-06 (p. 413 ~ 419   ) /   11장 동시성 , 아이템 78. 공유 중인 가변 데이터는 동기화해 사용하라    ](effective-java/docs/76일차/76일차.md)
- [77일차 : 2024-07-07 (p. 420 ~ 427  ) /   아이템 79.  과도한 동기화는 피하라  ](effective-java/docs/77일차/77일차.md)
- [78일차 : 2024-07-08 (p. 428 ~  430 ) /   아이템 80.  스레드보다는 실행자, 태스크, 스트림을 애용하라  ](effective-java/docs/78일차/78일차.md)
- [79일차 : 2024-07-09 (p. 431 ~ 437  ) /   아이템 81.  wait 와 notify 보다는 동시성 유틸리티를 애용하라  ](effective-java/docs/79일차/79일차.md)
- [80일차 : 2024-07-10 (p. 438 ~ 441   ) /   아이템 82. 스레드 안정성 수준을 문서화하라  ](effective-java/docs/80일차/80일차.md)
- [81일차 : 2024-07-11 (p. 442 ~ 445   ) /   아이템 83. 지연 초기화는 신중히 사용하라  ](effective-java/docs/81일차/81일차.md)
- [82일차 : 2024-07-12 (p. 446 ~ 468   ) /   아이템 84. 프로그램의 동작을 스레드 스케줄러에 기대지 말라   ](effective-java/docs/82일차/82일차.md)
- [83일차 : 2024-07-13 (p. 449 ~ 454    ) / 12장 직렬화 ,  아이템 85.  자바 직렬화의 대안을 찾으라   ](effective-java/docs/83일차/83일차.md)
- [84일차 : 2024-07-14 (p. 455 ~ 458    ) / 아이템 86. Serializable 을 구현할지는 신중히 결정하라   ](effective-java/docs/84일차/84일차.md)
- [85일차 : 2024-07-15 (p. 459 ~ 466   ) / 아이템 87. 커스텀 직렬화 형태를 고려해보라   ](effective-java/docs/85일차/85일차.md)
- [86일차 : 2024-07-16 (p. 467 ~  473  ) / 아이템 88. readObject 메서드는 방어적으로 작성하라   ](effective-java/docs/86일차/86일차.md)
- [87일차 : 2024-07-17 (p. 474 ~ 478   ) / 아이템 89. 인스턴스 수를 통제해야 한다면 readResolve 보다는 열거 타입을 사용하라   ](effective-java/docs/87일차/87일차.md)
- [88일차 : 2024-07-18 (p. 479 ~ 482   ) / 아이템 90. 직렬화된 인스턴스 대신 직렬화 프록시 사용을 검토하라   ](effective-java/docs/88일차/88일차.md)
...
- [ (p. 1 ~ 11    ) / 01. 계층형 아키텍처의 문제는 무엇일까?     ](clean-architecture/docs/1일차/1일차.md)
- [ (p. 12 ~ 22    ) /  02.  의존성 역전하기      ](clean-architecture/docs/2일차/2일차.md)
- [ (p. 23 ~ 32    ) /  03. 코드 구성하기     ](clean-architecture/docs/3일차/3일차.md)
- [ (p.33 ~ 52    ) /  04. 유스케이스 구현하기     ](clean-architecture/docs/4일차/4일차.md)
- [ (p.53 ~ 62    ) /  05. 웹 어댑터 구현하기   ](clean-architecture/docs/5일차/5일차.md)
- [(p.63 ~ 79    ) / 06. 영속성 어댑터 구현하기  ](clean-architecture/docs/6일차/6일차.md)
- [(p.80 ~ 96    ) / 07. 아키텍처 요소 테스트하기 ](clean-architecture/docs/7일차/7일차.md)
- [  (p.97 ~    ) / 08. 경계 간 매핑하기 ](clean-architecture/docs/8일차/8일차.md)
...
- [(p.53 ~ 87  ) / 1장 오브젝트와 의존관계 , 1.1 초난감 DAO , 1.2 DAO 의 분리  , 1.3 DAO의 확장   ](toby-spring/docs/1일차/1일차.md)
- [ (p.88 ~ 102  ) / 1.4 제어의 역전 (IoC) , 1.5 스프링의 IoC  ](toby-spring/docs/2일차/2일차.md)
- [ (p.103 ~ 127 ) / 1.6 싱글톤 레지스트리 , 1.7 의존관계 주입 (DI) ](toby-spring/docs/3일차/3일차.md)
- [(p.128 ~ 143  ) /   ](toby-spring/docs/4일차/4일차.md)
- [ (p.145 ~ 160  ) /](toby-spring/docs/5일차/5일차.md)
- [(p.161 ~ 182    ) /  ](toby-spring/docs/6일차/6일차.md)
- [ (p.183 ~ 196  ) /   ](toby-spring/docs/7일차/7일차.md)
- [ (p.197 ~ 207   ) / ](toby-spring/docs/8일차/8일차.md)
- [(p.209 ~ 224   ) / 3장 템플릿 ,3.1 다시 보는 초난감 DAO  ,3.2 변하는 것과 변하지 않는 것  ](toby-spring/docs/9일차/9일차.md)
- [(p.224 ~ 240  ) / 3.3 JDBC 전략 패턴의 최적화 , 3.4 컨텍스트와 DI  ](toby-spring/docs/10일차/10일차.md)
- [(p.240 ~ 258   ) / 3장 템플릿 , 3.5 템플릿과 콜백   ](toby-spring/docs/11일차/11일차.md)
